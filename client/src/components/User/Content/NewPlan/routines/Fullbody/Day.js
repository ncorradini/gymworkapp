    ...
    return (
        <div className="newplan__routine--day">
            <div className="newplan__routine--day__ejercise">
                <h4>Cuadriceps</h4>
                <select id={`${frecuency}-quadriceps-one`} defaultValue="default" onChange={handleChange}>
            ...
            <div className="newplan__routine--day__ejercise">
                <h4>Isquios</h4>
                <select id={`${frecuency}-hamstrings-one`} defaultValue="default" onChange={handleChange}>
                    <option value="default" disabled>Seleccione ejercicio</option>
